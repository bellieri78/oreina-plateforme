...
class SubmissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'status' => 'required|in:submitted,under_initial_review,revision_requested,under_peer_review,revision_after_review,in_production,accepted,rejected,published',
