...
/**
 * Sent to editorial staff (assigned editor + chief editors) when the author
 * approves the layout for publication. Caller must iterate and dispatch per recipient.
 */
