{{-- Modale d'inscription Newsletter (Alpine.js, autonome).
     S'ouvre via $dispatch('open-newsletter') depuis n'importe où. Se ferme via 'close-newsletter' ou en interne. --}}
<div x-data="{
        open: false,
        loading: false,
        success: false,
     ...
     @open-newsletter.window="open = true"
     @close-newsletter.window="open = false"
     @keydown.escape.window="open = false">
    <div class="newsletter-modal"
         x-show="open"
         x-transition.opacity
         x-cloak>
        <div class="newsletter-modal-overlay" @click="open = false"></div>
