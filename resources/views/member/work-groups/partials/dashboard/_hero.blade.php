<div class="gt-hero">
    <div class="gt-hero-thumb" style="{{ $workGroup->coverUrl() ? '' : 'background:'.($workGroup->color ?? '#85B79D').';' }}">
    ...
    <div class="gt-hero-body">
        ...
        <div class="gt-meta">
            <span><i data-lucide="users"></i>{{ $workGroup->active_members_count }} membres</span>
            <span><i data-lucide="calendar"></i>Créé en {{ $workGroup->created_at?->format('Y') }}</span>
        </div>
