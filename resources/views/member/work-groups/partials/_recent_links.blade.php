<div class="card panel">
    <div class="panel-head">
        <div><h2>Ressources utiles</h2></div>
    ...
    @forelse($recentLinks as $r)
    <div style="display:flex;align-items:flex-start;gap:10px;padding:9px 0;border-bottom:1px solid var(--border);">
        <i data-lucide="link" style="width:16px;height:16px;flex-shrink:0;margin-top:3px;color:var(--blue);"></i>
        <div style="flex:1;min-width:0;">
            <a href="{{ $r->url() }}" target="_blank" rel="noopener" class="text-link" style="display:block;font-weight:700;">{{ $r->title }}</a>
